...
- Adaptive search depth: shallow k=30 for confident queries, deep k=100 when unsure (LongMemEval sweep at `benchmarks/results/bench_deep_pass.md` shows NDCG@10 is flat past rank 100, so the previous k=200 was pure rerank overhead)
